          ...
          <div className="w-full max-w-sm p-6">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <p className="text-center text-xs text-gray-400">
                ...
                <button type="button" onClick={() => navigate('/register')} className="text-[#00F0FF] hover:underline font-medium bg-transparent border-none cursor-pointer">Sign up</button>
              </p>
            </form>
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-[#0A0C10] text-gray-400">Or continue with</span>
              </div>
            </div>

            {/* Google - only functional social auth */}
            <button
              type="button"
